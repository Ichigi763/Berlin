...
-- OFFICIAL ELERIUM V2 UI LIBRARY (STRICT MODIFIED ENGINE)
-- ============================================================

local library = (function()
local ui_options = {
	main_color = Color3.fromRGB(43, 82, 146),
...
tabs.Position = UDim2.new(0, 145, 0, 35)
tabs.Size = UDim2.new(1, -155, 1, -45)
...
tabSelection.Size = UDim2.new(0, 130, 1, -45)
...
-- Create Elerium v2 Window
local window = library:AddWindow("Berlin v0.1", {
    main_color = Color3.fromRGB(43, 82, 146), -- Atlas Blue
    min_size = Vector2.new(780, 440),         -- Atlas Dimensions
    toggle_key = Enum.KeyCode.RightShift,
    can_resize = true,
})

-- Add Vertical Tabs via Elerium
...
-- HOME TAB (ELERIUM CONTROLS + UPTIME + STOP EVERYTHING)
...
print("==================================================")
print("✅ Berlin v0.1 (Strict Elerium Engine + Fixed Minimize & Timers) Ready!")
print("==================================================")
